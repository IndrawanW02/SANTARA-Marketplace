<%@ Page Title="SANTARA" Language="C#" MasterPageFile="~/Template/HeaderAndFooter.Master" AutoEventWireup="true" CodeBehind="PriaProductPage.aspx.cs" Inherits="SANTARA_Marketplace.Views.ManProductPage" MaintainScrollPositionOnPostback="true" %>
    ...
    <section>
        ...
        <div class="filter-section">
            <div class="filter-container">
                ...
                <asp:DropDownList class="DD" ID="SortBy" runat="server" AutoPostBack="true" OnSelectedIndexChanged="SelectedIndexChanged">
                    ...
                    <asp:ListItem Text="Hagra Termahal" Value="HargaDesc"></asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="filter-container">
            ...
            <div class="reset-filter-container">
                <asp:Button ID="ResetFilter" runat="server" Text="RESET FILTER" CssClass="reset-filter-btn" OnClick="ResetFilter_Click" />
            </div>
        </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="ResetFilter" EventName="Click" />
            </Triggers>
        </asp:UpdatePanel>
    </section>
</asp:Content>
